...
export class CreateAdComponent implements OnInit {
  ...
  formMessageCompletion = '';
  formTabSelectedIndex = '0';
  formErrors = {
    'name': '',
    'price': '',
    'console': '',
  ...
  completeTab(control: string, value: string) {
    ...
    switch (control) {
      case 'console':
        ...
        this.formCreateAd.controls[control].updateValueAndValidity({onlySelf: true});
  ...
  onGameSelected(game: Game) {
    ...
    this.formCreateAd.controls['name'].updateValueAndValidity({onlySelf: true});
    if (this.gameSelected && this.gameSelected.cover) {
      this.adImageSrc = '';
    }
  }
